...
let myFavoriteNumber = 7; // Integer
let myHeight = 5.9; // Float
let myWeight = 160; // Integer
let myFavoriteLetter = 'A'; // String
...
console.log("The product of the numbers = " + products);
...
let averages = (i1 + i2) / 2;

console.log("The average of the numbers is: " + averages);
...
let favBook = "JS Algorithms & Data Structures"; // String
let favColor = "Blue"; // String
let favNumber = 7; // Integer
...
let age = 45; // Integer
let emailAddress = "johndoe@gmail.com"; // String
let phoneNumber = "(123) 123 1234"; // String
let address = "123 St Chicago IL 12345"; // String
